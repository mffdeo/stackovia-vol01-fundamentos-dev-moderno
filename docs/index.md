...
hero:
  ...
  tagline: "Da primeira linha de terminal ao primeiro capítulo publicado no GitHub."
  actions:
    - theme: brand
...
features:
  - title: "Cap. 01 — Entrada na Stackovia"
    details: "Escopo, evidência e maturidade: o que significa entregar algo que pode ser mostrado."
    link: /capitulos/cap01
    linkText: "Ler capítulo →"
  - title: "Cap. 02 — Como a internet funciona"
    details: "URL, DNS, HTTP, status codes e por que 'caiu' não é diagnóstico."
    link: /capitulos/cap02
    linkText: "Ler capítulo →"
  - title: "Cap. 03 — Terminal, pastas e arquivos"
